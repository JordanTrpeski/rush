...
export function Header({ toggleSideBar }: { toggleSideBar?: () => void }) {
  ...
  return <nav className="flex items-center justify-between flex-wrap bg-[#4A5568] p-6">
    <div className="flex items-center flex-shrink-0 text-white mr-6">
      <span className="font-logo font-semibold text-xl tracking-tight">Macedonia Bazar</span>
    </div>
    {
    ...
    <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
      <div className="text-sm lg:flex-grow">
        <a href="/" className="block mt-4 lg:inline-block lg:mt-0 text-[#FFFFFF] hover:text-white mr-4">
          Home
        </a>
      </div>
